...
from .Trainer.Utils import apply_lora_to_unet, safestore_lora, auto_detect_batch_size

output_dir = folder_paths.get_output_directory()
models_dir = folder_paths.get_folder_paths("models/checkpoints")
...
class LoraTrainer:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "base_model" : ("MODEL",),
                "output_name" : ("STRING", {"default" : "output_model.safestore"})
            },
            "optional": {
            }
        }
    ...
    def train_lora(self, dataset_path, epochs, base_model, output_name, lr=5e-5):
